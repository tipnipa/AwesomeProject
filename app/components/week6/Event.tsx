                    ...
                    ({ item, index }:any) => {
                        ...
                        return (
                            <View style={{ marginRight: 10 }} >
                                <Image style={{ width: Dimensions.get("screen").width / 1.5, height: 150, borderTopLeftRadius : 10, borderTopRightRadius : 10 }} source={{ uri: item.uri }} />
                                <View style={{ width: Dimensions.get("screen").width / 1.5,flexDirection : "row", backgroundColor : 'white', borderWidth : 1 , borderColor : "grey" , borderBottomLeftRadius : 10 , borderBottomRightRadius : 10}}>
